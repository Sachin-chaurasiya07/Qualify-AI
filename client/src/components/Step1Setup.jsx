        ...
        >
          ...
          <div className="space-y-6">
            ...
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Your Experience (example : 1-12)"
                className="w-full pl-12 pr-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500 outline-none transition"
            ...
            <select
              ...
              className="w-full py-3 px-4 border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500 outline-none transition"
            >
            ...
            {!analysisDone && (
                ...
                className="border-2 border-dashed border-gray-300 rounded-xl p-8 text-center cursor-pointer hover:border-green-500 hover:bg-green-100 transition">
