...
function Step3Report({report}){
    ...
    if(finalScore>= 8){
        ...
        performanceText = 'Need more improvement before interview,';
        shortTagline = 'Good foundation,need little clarity';
    }
    else{
        performanceText = 'Kuch nahi aata, padhlyo';
        shortTagline = 'Work of yourself and basic topics';
    }
    ...
    const downloadPDF = ()=>{
        ...
        if(finalScore >=8){
            advice = "Excellent performance, chak de fatte , 18 Lpa done";
        }
        else if(finalScore>=5){
            advice = "Good , bohot bdhiya , Need bit more fir 18 Lpa done";
        }
        else{
            advice = "Ky hoga apka is economy me, do Study ..... Just Study";
        }
        doc.setFillColor(255, 255, 255);
        doc.setDrawColor(220);
        doc.roundedRect(margin, currentY , contentWidth, 35,4,4);
        doc.setFont("helvetica", "bold");
        doc.text("Honest Advice : ", margin + 10,currentY+10);
        ...
        <div className="min-h-screen bg-linear-to-br from-gray-50 to-green-50 px-4 sm:px-6 lg:px-10 py-8">
            ...
            <div className="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div className="md:mb-10 w-full flex items-start gap-4 flex-wrap">
                    ...
                    <button
                    onClick={downloadPDF}
                    className="bg-emerald-600 hover:bg-emerald-900 text-white py-3 px-3 rounded-xl shadow-md transition-all duration-300 font-semibold text-sm sm:text-base text-nowrap">
                        Download report pdf
                    </button>
            </div>
                                ...
                                questionWiseScore.map((q,i)=>(
                                    <div key={i} className="bg-gray-50 p-4 sm:p-6 rounded-xl sm:rounded-2xl border border-gray-200">
                                        ...
                                        <div className="bg-green-50 border border-green-200 p-4 rounded-lg">
                                            <p  className="text-xs text-green-600 font-semibold md-1">
                                                Feedback
                                            </p>
