...
function Navbar(){
    ...
    return (
        <div className="bg-[#f3f3f3] flex justify-center px-4 pt-6">
            ...
            className="w-full max-w-6xl bg-white rounded-[24px] shadow-sm border-2 border-gray-200 px-8 py-4 flex justify-between items-center relative">
                <div className="flex items-center gap-3 cursor-pointer">
                    <div className="bg-black text-white p-2 rounded-lg">
                        <BsRobot size={18}/>

                    </div>
                    <h1 className='font-semibold hidden md:block text-lg'>Qualify AI</h1>
                ...
                <div className="flex items-center gap-6 relative">
                    ...
                    className="flex items-center gap-2 bg-gray-150 px-4 py-2 rounded-full text-md hover:bg-gray-300 transition">
                        <BsCoin size={20}/>
                        {userData?.credits || 0}
                    </button>
                    {showCreditPopup && (
                        <div className="absolute right:-50px mt-3 w-64 bg-white shadow-xl border border-gray-200 rounded p-5 z-50">
                            <p className="">Need more Credits to continue interviews</p>
