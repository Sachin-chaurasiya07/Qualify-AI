    ...
    <div className="min-h-screen bg-[#f3f3f3] flex flex-col">
      ...
      <div className="flex-1 px-6 py-20">
        ...
        <div className="flex justify-center mb-6">
          <div className="bg-gray-200 text-gray-800 text-sm px-4 py-2 rounded-full flex items-center gap-2">
        ...
        <div className="text-center mb-28">
          <motion.h1
            ...
            className="text-3xl md:text-5xl font-semibold leading-tight max-w-2xl mx-auto"
          >
          ...
          <div className="flex flex-wrap justify-center gap-4 mt-10">
            ...
            <motion.button
              ...
              whileHover={{ opacity: 0.9, scale: 1.03 }}
              whileTap={{ opacity: 1, scale: 0.98 }}
              className="bg-green-100 border border-gray-300 px-10 py-3 rounded-full hover:bg-gray-100 transition"
            >
              View History
            </motion.button>
          </div>
          ...
          {[
            {
              ...
              desc: "AI Adjusts difficulty based on selected jpb role.",
            },
            {
              icon: <BsMic size={24} />,
              step: "STEP2",
            ...
            >
              ...
              <div className="pt-10 text-center">
                <div className="text-s text-green-600 font-semibold mb-2 tracking-wider">
                  {item.step}
                </div>
          ...
          <div className="grid md:grid-cols-2 gap-10">
            {[
              ...
              },
              {
                ...
                desc: "Project specific questions based on improvement insights",
              },
              {
                image :pdfImg,
          ...
          <div className="grid md:grid-cols-2 gap-10">
            {[
              ...
              },
              {
                img: creditImg,
                title: "Credit System",
                desc: "Unlock premium style interview session",
              },
            ].map((mode, index) => (
              <motion.div
                key={index}
                ...
                transition={{ duration: 0.5, delay: index * 0.1 }}
                whileHover={{ y: -6 }}
                className="bg-[#f3f3f3] border border-gray-300 rounded-3xl p-8 shadow-sm hover:shadow-xl transition-all"
              >
